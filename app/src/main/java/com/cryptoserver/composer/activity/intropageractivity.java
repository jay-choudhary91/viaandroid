    ...
    private class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int pos) {
            switch(pos) {
                ...
                case 0: return pagerfragment.newInstance(getResources().getString(R.string.welcome_inapp),"#e69fb7",1);
                case 1: return pagerfragment.newInstance(getResources().getString(R.string.authentic_fraud),"#de779a",2);
                case 2: return pagerfragment.newInstance(getResources().getString(R.string.record_crop_count),"#cf3f70",3);
                default: return pagerfragment.newInstance(getResources().getString(R.string.welcome_inapp),"#e69fb7",1);
            }
        }
