...
public class folderdirectoryspinneradapter extends ArrayAdapter<String> {
    ...
    public folderdirectoryspinneradapter(@NonNull Context context, @LayoutRes int resource,
    ...
    private View createItemView(int position, View convertView, ViewGroup parent){
        ...
        folder_name.setText(items.get(position).getFoldername());
        return view;
    }
}