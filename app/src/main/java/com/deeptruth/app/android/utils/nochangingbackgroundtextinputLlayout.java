...
public class nochangingbackgroundtextinputLlayout extends TextInputLayout {
    public nochangingbackgroundtextinputLlayout(Context context) {
        super(context);
    }

    public nochangingbackgroundtextinputLlayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public nochangingbackgroundtextinputLlayout(Context context, AttributeSet attrs, int defStyleAttr) {
