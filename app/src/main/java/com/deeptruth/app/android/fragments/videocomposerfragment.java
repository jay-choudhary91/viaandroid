...
public class videocomposerfragment extends basefragment implements View.OnClickListener,View.OnTouchListener, Orientation.Listener {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    xdata.getinstance().saveSetting(config.servicedata_mediapath,lastrecordedvideo.getAbsolutePath());
    ...
    public void setData(boolean autostartvideo, adapteritemclick madapterclick, RelativeLayout layout_bottom,RelativeLayout layout_mediatype, RelativeLayout layout_seekbarzoom, FrameLayout framecontainer,ImageView recordbutton) {
