...
public enum mediatypepagerenum_audio
{

    Item1("", R.layout.row_composemediatype,0),
    Item2("", R.layout.row_composemediatype,1),
    Item3("", R.layout.row_composemediatype,2),
    Item4("", R.layout.row_composemediatype,3),
    ...
    mediatypepagerenum_audio(String itemname, int layoutResId, int itemposition) {
